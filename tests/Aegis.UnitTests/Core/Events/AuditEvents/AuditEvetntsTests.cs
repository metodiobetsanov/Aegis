namespace Aegis.UnitTests.Core.Events.AuditEvents
{
	using global::Aegis.Core.Contracts.Application.Events;
	using global::Aegis.Core.Events.Audit.DataProtection;
	using global::Aegis.Core.Events.AuditLog.Handlers;
