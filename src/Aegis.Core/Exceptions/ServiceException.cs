...
namespace Aegis.Core.Exceptions
{
	...
	public class ServiceException : Exception, IAegisException
	{
		...
		public ServiceException()
			: base(ServiceConstants.SomethingWentWrong) => this.DebugMessage = ServiceConstants.SomethingWentWrong;
		...
		public ServiceException(string? message, string? debugMessage, Exception? innerException)
