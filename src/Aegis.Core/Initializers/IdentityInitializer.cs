...
namespace Aegis.Core.Initializers
{
	...
	public sealed class IdentityInitializer : IInitializer
	{
		...
		/// <exception cref="Aegis.Core.Exceptions.InitializerException">
		...
		/// <exception cref="Aegis.Core.Exceptions.InitializerException">Failed to create '{roleName}' role.</exception>
