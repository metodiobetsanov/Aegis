namespace Aegis.Application.Commands.Authentication.Handlers
{
	...
	/// </summary>
	/// <seealso cref="Aegis.Application.Contracts.CQRS.ICommandHandler&lt;Aegis.Application.Commands.Authentication.SignInTwoStepCommand, Aegis.Models.Authentication.SignInCommandResult&gt;" />
	public sealed class SignInTwoStepCommandHandler : ICommandHandler<SignInTwoStepCommand, SignInCommandResult>
	{
		...
		/// <returns>
		///   <see cref="Aegis.Models.Authentication.SignInTwoStepCommand" />
		/// </returns>
