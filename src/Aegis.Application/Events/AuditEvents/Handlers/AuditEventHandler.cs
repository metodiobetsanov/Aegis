namespace Aegis.Application.Events.AuditLog.Handlers
{
	...
	/// <seealso cref="Aegis.Application.Contracts.Application.Events.IAuditEventHandler&lt;TEvent&gt;" />
		...
		where TEvent : IAuditEvent
	{
		...
		public Task Handle(TEvent notification, CancellationToken cancellationToken)
		{
			...
			AuditLog log = new AuditLog(
				notification.GetType().Name.Replace("AuditEvent", ""),
				notification.Succeeded,
				(int)notification.Module,
				(int)notification.Action,
				(int)notification.Subject,
