namespace Aegis.Application.Queries.Auth.Handlers
{
	...
	/// </summary>
	/// <seealso cref="Aegis.Application.Contracts.CQRS.IQueryHandler&lt;Aegis.Application.Queries.Auth.ConfirmEmailQuery, Aegis.Models.Auth.EmailConfirmationQueryResult&gt;" />
